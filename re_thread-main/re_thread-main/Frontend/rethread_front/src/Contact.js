      ...
      <div >
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          <Card className='animate_from_bottom' sx={{ width: 330, marginTop: 3, marginLeft: 3, marginBottom:3, boxShadow: 5 }}>
            <CardActionArea component={Link} href="https://www.instagram.com/harrymishra91" target="_blank">
              <CardMedia
                component="img"
                height="160"
                image={insta}
          ...
          <Card className='animate_from_bottom' sx={{ width: 330, marginTop: 3, marginLeft: 3, marginBottom:3, boxShadow: 5 }}>
            <CardActionArea component={Link} href="https://www.linkedin.com/in/harikishor-mishra-714058260" target="_blank">
              <CardMedia
                component="img"
                height="160"
                image={linkedin}
          ...
          <Card className='animate_from_bottom' sx={{ width: 330, marginTop: 3, marginLeft: 3, marginBottom:3, boxShadow: 5 }}>
            <CardActionArea component={Link} href="https://github.com/harikishoremishra" target="_blank">
              <CardMedia
                component="img"
                height="160"
                image={github}
          ...
          <Card className='animate_from_bottom' sx={{ width: 330, marginTop: 3, marginLeft: 3, marginBottom:3, boxShadow: 5 }}>
            <CardActionArea component={Link} href="https://mail.google.com/mail/?view=cm&fs=1&to=harikishorpwn2020@gmail.com" target="_blank">
              <CardMedia
                component="img"
                height="160"
                image={gmail}
